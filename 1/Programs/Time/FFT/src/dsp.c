...
Array_d* LMS( Array_d* input, Array_d* unknown_system ) {
	...
	Array_d *system         = newArray_d( filter_length )
	      , *desired_signal = newArray_d( data_length )
	      , *output_signal  = newArray_d( data_length )
	      , *error          = newArray_d( data_length )
	      , *error_log      = newArray_d( data_length )
	;
	...
	printArray_dToFile( desired_signal, D_FN );
	printArray_dToFile( error, E_FN );
	printArray_dToFile( error_log, E_LOG_FN );

	printArray_dToFile( system, "../filter.txt" );
