...
Array_d* calcCorrelationFunction( Array_d* original_vector1, Array_d *original_vector2 ) {
	...
	printArray_cToFile( vector1, "debug/vec1.txt" );
	printArray_cToFile( vector2, "debug/vec2.txt" );
	printArray_cToFile( ffted1, "debug/ffted1.txt" );
	printArray_cToFile( ffted2, "debug/ffted2.txt" );
	printArray_cToFile( power_spectrum, "debug/power.txt" );
